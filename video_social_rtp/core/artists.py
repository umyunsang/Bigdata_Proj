...
# Patterns include English, stylised, and Hangul variants to improve recall.
...
def extract_artist(title: str | None, channel_id: str | None) -> str:
...
__all__ = ["extract_artist", "ARTIST_PATTERNS", "OFFICIAL_CHANNELS"]
