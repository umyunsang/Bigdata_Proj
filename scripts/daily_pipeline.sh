...
FORCE_MOCK="${PIPELINE_FORCE_MOCK:-}"
TOP_PCT="${PIPELINE_TOP_PCT:-0.9}"
BRONZE_FALLBACK="${PIPELINE_BRONZE_FALLBACK_LOCAL:-}"
SILVER_FALLBACK="${PIPELINE_SILVER_FALLBACK_LOCAL:-}"
GOLD_FALLBACK="${PIPELINE_GOLD_FALLBACK_LOCAL:-}"
TRAIN_FALLBACK="${PIPELINE_TRAIN_FALLBACK_LOCAL:-}"
