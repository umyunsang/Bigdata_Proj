...
부록: 제출물 구성 및 PDF 변환
- 제출 산출물: `submission/과제01~05/` 폴더(README, screenshots), `submission/스크린샷_가이드.md`
- 보고서 PDF 변환(권장): VS Code Markdown → PDF, 또는 `pandoc`/`wkhtmltopdf` 사용
  - 예: `pandoc submission/보고서_최종.md -o submission/보고서_최종.pdf`
